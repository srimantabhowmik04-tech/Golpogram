...
class GolpogramApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const GolpogramFeedScreen(),
    );
  }
}
...
class GolpogramFeedScreen extends StatefulWidget {
  const GolpogramFeedScreen({super.key});
...
class _GolpogramFeedScreenState extends State<GolpogramFeedScreen> {
  ...
  final List<PostItem> _posts = [
    PostItem(
      ...
      time: '10 mins ago',
      text: 'স্বাগতম গল্পগ্রামে! এখানে প্রতিদিনের ছোট ছোট গল্প ও ভাবনা শেয়ার করুন। 🌿✨',
      likes: 5,
      isLiked: true,
      comments: ['দারুণ কনসেপ্ট!', 'অ্যাপটা খুব ফাস্ট চলছে।'],
    ),
    PostItem(
      id: '2',
      author: 'Golpo Premi',
